const redberryTexts = [
    {
        ...
        description: `You watch “What? Where? When?” Yeah. Our founders used to play it. 
    ...
    },
    {
        ...
        description: `As we said, Redberry has been on the field for quite some time now, 
    ...
    },
    {
        ...
        description: `As this infamous pandemic took over the world, 
    ...
    },
    {
        ...
        description: `We were soo much fun before the pandemic started! 
        Parties almost every weekend and lavish employee birthday celebrations! Unfortunately, 
        covid ruined that fun like it did almost everything else in the world. But we try our best to zhuzh it up a bit. 
        For example, we host biweekly Devtalks where our senior and lead developers talk about topics they are passionate about. 
...
export function getRedberryText(index){
    return redberryTexts[index];
}
